...
class TestSentimentCount(unittest.TestCase):
    ...
    def test_clear_str(self):
        ...
        self.assertEqual(self.sentiment_count.clear_str('Good,,Job'), 'goodjob')
        self.assertEqual(self.sentiment_count.clear_str('Tab    test\n  here  \t jobs;;g;,5%'), 'tab test here jobsg')
        self.assertEqual(self.sentiment_count.clear_str('   so   MaNy  spaces h44;*ere!!!       '),
                         'so many spaces here')
